...
export FZF_DEFAULT_OPTS="--color=border:#268bd2 --border=none --margin 0,0 --preview-window=border-sharp:wrap --no-separator --info=inline-right --bind 'ctrl-e:execute(echo {+} | xargs -o nvim)'"

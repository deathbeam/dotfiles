...
# c.content.canvas_reading = False # Breaks 9gag, wolt, captcha if False
# c.content.cookies.accept = "no-unknown-3rdparty" # because trash microsoft teams doesnt work without allowing all

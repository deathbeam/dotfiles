...
append_config "AlertBrokenExecutables yes" "$CLAMD_CONF"
append_config "AlertBrokenMedia yes" "$CLAMD_CONF"
append_config "AlertEncrypted yes" "$CLAMD_CONF"
append_config "AlertEncryptedArchive yes" "$CLAMD_CONF"
append_config "AlertEncryptedDoc yes" "$CLAMD_CONF"
append_config "AlertOLE2Macros yes" "$CLAMD_CONF"
append_config "AlertPartitionIntersection yes" "$CLAMD_CONF"
